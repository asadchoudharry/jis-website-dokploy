...
const StickyNav: React.FC<{ activeSection: string; }> = ({ activeSection }) => {
    ...
    const ns = 'services_pages.waste_management';
    const navItems = [
        { id: 'overview', label: t(`${ns}.nav_overview`) },
        { id: 'services', label: t(`${ns}.nav_services`) },
        { id: 'approach', label: t(`${ns}.nav_approach`) },
        { id: 'compliance', label: t(`${ns}.nav_compliance`) },
    ];
...
const WasteManagement: React.FC = () => {
    ...
    const approachStepsData = t(`${ns}.approach_steps`, { returnObjects: true });
    const approachSteps = Array.isArray(approachStepsData) ? approachStepsData : [];

    const compliancePointsData = t(`${ns}.compliance_points`, { returnObjects: true });
    const compliancePoints = Array.isArray(compliancePointsData) ? compliancePointsData : [];
    ...
    return (
        <>
            ...
            <section id="overview" ref={sectionRefs.overview} className="py-12 md:py-20 bg-jis-bg-gray relative overflow-hidden">
                <div className="absolute inset-0 waste-pattern-light opacity-50"></div>
            ...
            <section id="services" ref={sectionRefs.services} className="py-12 md:py-20 bg-white relative overflow-hidden">
                 <div className="absolute inset-0 waste-pattern-light opacity-25"></div>
                <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 space-y-12 md:space-y-20">
                    <div className="flex flex-col items-center gap-8 md:flex-row lg:gap-12">
                        <div className="w-full flex-1">
                            <h3 className="text-2xl font-bold leading-tight text-slate-900">{t(`${ns}.service1_title`)}</h3>
                            <p className="mt-2 text-base font-normal leading-normal text-slate-600">{t(`${ns}.service1_desc`)}</p>
                        </div>
                        <div className="aspect-video w-full flex-1 rounded-lg bg-cover bg-center shadow-md" style={{backgroundImage: `url('${t(`${ns}.service1_image`)}')`}}></div>
                    </div>
                    <div className="flex flex-col items-center gap-8 md:flex-row-reverse lg:gap-12">
                        <div className="w-full flex-1">
                             <h3 className="text-2xl font-bold leading-tight text-slate-900">{t(`${ns}.service2_title`)}</h3>
                            <p className="mt-2 text-base font-normal leading-normal text-slate-600">{t(`${ns}.service2_desc`)}</p>
                        </div>
                        <div className="aspect-video w-full flex-1 rounded-lg bg-cover bg-center shadow-md" style={{backgroundImage: `url('${t(`${ns}.service2_image`)}')`}}></div>
                    </div>
                </div>
            </section>

            <section id="approach" ref={sectionRefs.approach} className="py-12 md:py-20 bg-jis-bg-gray relative overflow-hidden">
                <div className="absolute inset-0 waste-pattern-light opacity-50"></div>
                <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-10">
                        <h2 className="text-3xl font-bold text-slate-900">{t(`${ns}.approach_title`)}</h2>
                        <p className="mt-4 text-lg text-slate-600">{t(`${ns}.approach_subtitle`)}</p>
                    </div>
            ...
            <section id="compliance" ref={sectionRefs.compliance} className="py-12 md:py-20 bg-white relative overflow-hidden">
                <div className="absolute inset-0 waste-pattern-light opacity-25"></div>
                <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col items-center gap-8 md:flex-row lg:gap-12">
                        <div className="aspect-video w-full flex-1 rounded-lg bg-cover bg-center shadow-md" style={{backgroundImage: `url('${t(`${ns}.compliance_image`)}')`}}></div>
                        <div className="w-full flex-1">
                            <span className="font-semibold text-jis-green uppercase tracking-wider">{t(`${ns}.compliance_tag`)}</span>
                            <h2 className="mt-2 text-3xl font-bold leading-tight text-slate-900">{t(`${ns}.compliance_title`)}</h2>
                            <p className="mt-4 text-base text-slate-600">{t(`${ns}.compliance_desc`)}</p>
